               ...
               <?php echo form_open_multipart('hotelsummaries/search_result',array("id"=>"search_result_form"));?>
               	<div id="search_box">
                        ...
                        <div id="room_option">
                         ...
                         <div class="label_05"><input class="button_01" type="button" value="Search"  name="search_button" onclick="validateGuests(this.form);" /></div> 
                         <div class="clr"></div>
                    </div>
                    <?php echo form_close();?>
                    <!--SEARCH BOX END-->
                    ...
                    $country =  $All_Featured_Destination['country_code'];					$current_lang = $this->session->userdata('Language_code');
                    $HotelData = $this->Destination_model->hotel_by_city($city, $current_lang); 
                    //print_r($HotelData);
                    ?>
                    <div class="place_box">
                    	<div class="picture">
                        ...
                        ?>
                    		<div class="box_row">
                                ...
                                <a  href="<?php echo base_url().'hotel-details/'.$HotelDataVal['ean_hotel_id'].'/'.str_replace(" ","-",mb_strtolower($HotelDataVal['name'], 'UTF-8'))?>"><img  src="<?php echo $HotelDataVal['thumbnail_url'];?>" width="40" height="40" alt="" title="" border="0"  /></a>
                               <?php }else{?> <a  href="<?php echo base_url().'hotel-details/'.$HotelDataVal['ean_hotel_id'].'/'.str_replace(" ","-",mb_strtolower($HotelDataVal['name'], 'UTF-8'));?>"><img  src="<?php echo base_url()?>images/no_image_thumb.jpg" width="40" height="40"  alt="" title="" border="0"  /></a><?php } ?>
                                </div>
                                   <div class="cell_02">
                                   	<h4><a href="<?php echo base_url().'hotel-details/'.$HotelDataVal['ean_hotel_id'].'/'.str_replace(" ","-",mb_strtolower($HotelDataVal['name'], 'UTF-8'))?>"><?php echo $HotelDataVal["name"];?></a> <img src="images/<?php echo str_replace(".","",$HotelDataVal["star_rating"])?>_stars.png" alt="" /></h4>        
                                        <p><?php echo getReviewRating($HotelDataVal['ean_hotel_id']); ?></p>
                                        
										<?php if(getBookingTime($HotelDataVal['ean_hotel_id'])!=""){ ?>
										<div class="booking"><?php echo $LANG['Latest booking']== NULL?'Latest booking':$LANG['Latest booking'] ;?>:  <?php 
										echo getBookingTime($HotelDataVal['ean_hotel_id']); ?> ago <img src="<?php echo base_url()?>images/icon_02.png" alt="" /></div>
										<?php } ?>
                                   ...
                                   <div class="cell_03">
                                   	<span><?php echo $LANG['from']== NULL?'from':$LANG['from'] ;?></span>
                                        <?php echo getCurrencySymbol($to_Currency);?> <?php echo $low_rate;?>
                                   </div>
                              </div>
                              <?php
							$cnt++;
               ...
               <div class="right_panel">
                             ...
                             <div class="heading">
							  ...
							  <div class="country_box">
								...
								<?php foreach($all_country_lists_by_continent as $Country_From_Hotel) { if($Country_From_Hotel['country_name'] != "") { $td++; $i++; $tr++; ?>
                                   	<li style="width:110px;"><img src="<?php echo base_url(); ?>country_flag/flags_thumb/<?php echo str_replace(" ","_",strtolower($Country_From_Hotel['country_name'])); ?>.png" alt="" />  
                                    <a href="<?php echo base_url().'hotelsummaries/search_by_country/'.$Country_From_Hotel['country_code'].'/'.str_replace(" ","-",mb_strtolower($Country_From_Hotel['country_name'], 'UTF-8'));?>"><?php echo $Country_From_Hotel['country_name'];?></a>
                                <?php if($td=='5')
									 {
										echo '</li></ul></div><div class="country_box"><ul>';
										$td=0;
									 }
								 } } 
								?>        
							  ...
							  <div class="country_box">
                              	<ul>
								<?php foreach($all_country_lists_by_continent as $Country_From_Hotel) { if($Country_From_Hotel['country_name'] != "") { $td++; $i++; $tr++; ?>
                                   	<li style="width:170px;"><img src="<?php echo base_url(); ?>country_flag/flags_thumb/<?php echo str_replace(" ","_",strtolower($Country_From_Hotel['country_name'])); ?>.png" alt="" />  
                                    <a href="<?php echo base_url().'hotelsummaries/search_by_country/'.$Country_From_Hotel['country_code'].'/'.str_replace(" ","-",mb_strtolower($Country_From_Hotel['country_name'], 'UTF-8'));?>"><?php echo $Country_From_Hotel['country_name'];?></a>
                                <?php if($td=='5')
									 {
										echo '</li></ul></div><div class="country_box"><ul>';
                ...
                <?php if(count($Top_Destination) > 0) { ?>
                            ...
                            <?php 
                              ...
                              <div class="text_box">
                              	<h5><a href="<?php echo base_url().'hotelsummaries/hotel_search_by_city/'.$All_Top_Destination['city'].'/'.$All_Top_Destination['country_code']?>"><?php echo $All_Top_Destination['city'];?></a></h5>
                                   <div class="country"><img src="<?php echo base_url()?>country_flag/flags_thumb/<?php echo  str_replace(" ","_",strtolower($All_Top_Destination['country']));?>.png" alt="" /> <?php echo $All_Top_Destination['country'];?></div>
                                   <p><?php echo getnumberOfHotel($All_Top_Destination['city']); ?>&nbsp;<?php echo $LANG['hotels']== NULL?'hotels':$LANG['hotels'] ;?> </p>
                  ...
                  <div class="booking_box top_margin">
                  		<h3><?php echo $LANG['Why use']== NULL?'Why use':$LANG['Why use'] ;?> bookingandyou.com? </h3>
                         <ul>
                         	<li>
                  ...
                  <div class="blue_box top_margin">
					...
					<form name="general_subscription" id="general_subscription" action="<?php echo base_url()?>user/subscribe_general" method="post">
                    	<h4><?php echo $LANG['Save']== NULL?'Save':$LANG['Save'] ;?> 50% <?php echo $LANG['or more with us']== NULL?'or more with us':$LANG['or more with us'] ;?></h4>
                         ...
                         <input  type="submit" value="<?php echo $LANG['Subscribe']== NULL?'Subscribe':$LANG['Subscribe']?>" class="button_01 right" style=" margin-top:10px; margin-right:5px;" id="subscribe"/>
                         <div class="clr"></div>
                   </form>     
                    </div>
                  </div>
...
<script type="text/javascript">
      ...
      function renderRoomSelect() {
        var x = '';
        x += '<select class="search_option_list" name="numberOfRooms" onchange="setNumRooms(this.options[this.selectedIndex].value);">';
        for (var i = 1; i < 9; i++) {
      ...
      function refresh() {
        ...
        if (numRooms > 8) {
         ...
         // x += '<td'+cellStyle+'><nobr>'+textAdults+pad+'</nobr></td><td'+cellStyle+'><nobr>'+textChildren+pad+'</nobr></td></tr>\n';
          for (var i = 0; i < numRooms; i++) {
            ...
            x += '</td><td style="width:85px;">&nbsp;</td>';
            if (numRooms > 1) {
              x += '<td'+cellStyle+'><nobr><p>'+getValue(textRoomX, i+1)+pad + '</p></nobr></td>';
            } else {
              x += '<td'+cellStyle+'>&nbsp;</td>';
            }
            x += '<td'+cellStyle+'>';
            x += buildSelect('room-' + i + '-adult-total', 'setNumAdults(' + i + ', this.options[this.selectedIndex].value)', 1, 4, adultsPerRoom[i]);
            x += '</td><td style="width:94px;">&nbsp;</td><td'+cellStyle+'>';
          ...
          for (var i = 0; i < numRooms; i++) {
            if (childrenPerRoom[i] > 0) {
              if (!didHeader) {
                x += '<table class="hotel_tbl" border="0" cellpadding="0" cellspacing="2">\n';
                ...
                for (var j = 0; j < maxChildren; j++) {
                  x += '<td'+cellStyle+'><nobr><p>'+getValue(textChildX, j+1)+pad+'</p></nobr></td>\n';
                }
                didHeader = true;
              }
              x += '</tr>\n<tr><td'+cellStyle+'><nobr><p>'+getValue(textRoomX, i+1)+pad+'</p></nobr></td>';
              for (var j = 0; j < childrenPerRoom[i]; j++) {
                ...
                x += '<select class="search_option_list" name="room-'+i+'-child-'+j+'-age" onchange="setChildAge('+i+', '+j+', this.options[this.selectedIndex].value);">';
        ...
        $(".search_option_list").msDropdown();
        $(".hotel_tbl .ddcommon").css({'margin':'2px 0','width':'55px','background':'#FFFFFF', 'line-height':'16px','height':'27px'});
      }

      function buildSelect(name, onchange, min, max, selected) {
        var x = '<select class="search_option_list" name="' + name + '"';
        if (onchange != null) {
          x += ' onchange="' + onchange + '"';
        }
        x +='>\n';
      ...
      function validateGuests(form) {
        if (numRooms < 9) {
          ...
          if (missingAge) {
            ...
            //return true;
			send_url(form, numRooms, adultsPerRoom, childrenPerRoom, childAgesPerRoom);
          }
        } else {
          //return true;
		  send_url(form, numRooms, adultsPerRoom, childrenPerRoom, childAgesPerRoom);
...
function send_url(frm, numRooms, adultsPerRoom, childrenPerRoom, childAgesPerRoom) {
	...
	var rooms = numRooms;
	var room_adults = adultsPerRoom;
	var room_childs = childrenPerRoom; 
	var room_childs_ages = childAgesPerRoom;
	
	/*alert(numRooms);
	alert(adultsPerRoom);
	alert(childrenPerRoom);
	alert(childAgesPerRoom); */
            
    var    search_string = 'city='+city+'&state_province='+state+'&country='+country+'&checkin_date='+start_date+'&checkout_date='+end_date+'&amenity='+amenitylist+'&starrate='+starratelist+'&sortby='+sortby+'&propertytype='+propertytypelist+'&chaincode='+chaincodelist+'&pricerange='+pricerangelist+'&rooms='+numRooms+'&room_adults='+adultsPerRoom+'&room_childs='+childrenPerRoom+'&room_child_ages='+childAgesPerRoom;
