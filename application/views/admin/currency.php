...
$(document).ready(function(){
    ...
    $('.edit').click(function(){
        ...
        $('#cancelButton').click();
        $('#id1').val(aData['id1']);
		$('#currency_id').val(aData['currency_id']);
		$('#currency_details').val(aData['currency_details']);
    ...
    $('.delete').click(function(){
        eval($(this).closest('td').children('div:first').text());
        var answer = confirm("Do you really want to remove " + aData['currency_id'] + "?");
        if(answer){
            window.location = '<?php echo base_url();?>admin/currency/currency_delete/'+aData['id1'];
        }
	...
	$('.status').click(function(){
        ...
        var answer = confirm("Do you really want to Change status " + aData['currency_id'] + "?");
        if(answer){
            window.location = '<?php echo base_url();?>admin/currency/change_status/'+aData['id1']+'/'+aData['is_active'];
        }
	...
	$("#txt_currency_code").val("");
	$("#txt_currency_name").val("");
    $("#frm_search_2").submit();
});
...
<?php 
if($logged_user['AdminsStatus'] == 'S') {?><div style="padding-bottom : 10px; text-align: right;"><button id="addCurrency" class="frm_btn">Add currency</button></div><?php }?>
<div style="display:none;" id="lblVoucher"><?=$url_id?></div>
  <table width="100%" border="0" cellspacing="2" cellpadding="0" style="display:none;" id="formContainer">
    <tr>
      <td align="left" valign="top" class="headingTxt">currency</td>
    </tr>
    <tr>
      <td align="left" valign="top" class="border_1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <?php echo form_open_multipart(base_url().'admin/currency',array("id"=>"currency_form"));?>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					    <td width="200" align="right" valign="top">Currency Code<span class="red-star">*</span></td>
					    <td align="center" valign="top">:</td>
					    <td align="left" valign="top"><input name="currency_id" type="text" class="txtbox1" id="currency_id" valid='alpanum' size="30" /></td>
					</tr>
                    <tr>
					    <td width="200" align="right" valign="top">Currency Name<span class="red-star">*</span></td>
					    <td align="center" valign="top">:</td>
					    <td align="left" valign="top"><input name="currency_details" type="text" class="txtbox1" id="currency_details" valid='alpanum' size="30" /></td>
					</tr>
  ...
  <tr>
    <td>
    <form id="frm_search_2" name="frm_search_2" method="post" action="<?php echo base_url().'admin/currency';?>" >
  <input type="hidden" id="h_search" name="h_search" value="basic">
        ...
        <table width="100%" cellpadding="0" cellspacing="2" border="0" class="light_bg_tbl">
          <tr>
             <td width="15%" class="h_bg">Currency Code:</td>
            <td  colspan="3" class="light_bg_2">
            <input id="txt_currency_code" name="txt_currency_code" value="" type="text" size="28" valid="not" />
            </td>
            <td width="15%" class="h_bg">Currency Name:</td>
            <td  colspan="3" class="light_bg_2">
            <input id="txt_currency_name" name="txt_currency_name" value="" type="text" size="28" valid="not" />
            </td>
              </tr>
       <!-- </table>
...
<?php if(count($pageDetails) > 0){?>    
        ...
        <th class="h_bg" width="25%" title="Purchase Order No">Currency Code</th>
        <th class="h_bg" width="30%" title="Purchase Order No">Currency Name</th>
    ...
    <tr>
        ...
        <td align="center" valign="middle" class="light_bg"><?php echo $row["currency_id"];?></td>
        <td align="center" valign="middle" class="light_bg"><?php echo $row["currency_details"];?></td>
        ...
        <td align="center" valign="middle" class="light_bg">
            <div style="display:none">
                ...
                aData['currency_id'] 		= "<?php echo $row["currency_id"]?>";
                aData['currency_details']   = "<?php echo $row["currency_details"]?>";
